...
export default function ClientPage() {
  ...
  if (!isInvoice) {
    return (
      <div style={{ background: "#f4f4f5", minHeight: "100vh", padding: "48px 20px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", borderRadius: 12, overflow: "hidden", background: "#fff", border: "1px solid #e5e7eb" }}>
          <div style={{ background: "#0e0f11", color: "#d4a853", padding: "24px 28px", fontSize: 46, fontWeight: 800 }}>
            Nico Salgado Photography
          </div>
          <div style={{ padding: "72px 24px", textAlign: "center" }}>
            <div style={{ fontSize: 54, marginBottom: 10 }}>🔗</div>
            <div style={{ fontSize: 44, fontWeight: 800, color: "#1f2937", marginBottom: 8 }}>Link Not Found</div>
  ...
  return (
    <div style={{ background: "#f4f4f5", minHeight: "100vh", padding: "24px 20px" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", borderRadius: 12, overflow: "hidden", background: "#fff", border: "1px solid #e5e7eb" }}>
        <div style={{ background: "#0e0f11", color: "#d4a853", padding: "22px 28px", fontSize: 34, fontWeight: 800 }}>
          Nico Salgado Photography
        </div>
        <div style={{ padding: "28px" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 16 }}>
            <tbody>
              <tr>
                ...
                <td style={{ padding: "8px 0", textAlign: "right", fontWeight: 700 }}>{inv.clientName || "—"}</td>
              </tr>
              {!!inv.sessionType && (
                <tr>
              ...
              <tr style={{ borderTop: "2px solid #111827" }}>
                ...
                <td style={{ padding: "12px 0", textAlign: "right", fontWeight: 700 }}>{money(inv.totalAmount)}</td>
              </tr>
              {Number(inv.amountPaid || 0) > 0 && (
                <tr>
                  <td style={{ padding: "6px 0", color: "#059669", fontWeight: 700 }}>Paid</td>
                  <td style={{ padding: "6px 0", textAlign: "right", color: "#059669", fontWeight: 700 }}>
              ...
              {Number(inv.balanceDue || 0) > 0 && (
                <tr>
                  <td style={{ padding: "6px 0", color: "#dc2626", fontWeight: 700 }}>Balance Due</td>
                  <td style={{ padding: "6px 0", textAlign: "right", color: "#dc2626", fontWeight: 800 }}>
          ...
          {!!inv.notes && (
            <div style={{ marginTop: 20, paddingTop: 12, borderTop: "1px solid #e5e7eb", fontSize: 14, color: "#4b5563" }}>
              {inv.notes}
            </div>
          )}
        </div>
